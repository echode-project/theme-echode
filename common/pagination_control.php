...
<nav class="pagination-nav" aria-label="<?php echo __('Pagination'); ?>">
  <ul class="pagination">
    ...
    <li class="pagination_previous">
      ...
      <a rel="prev" href="<?php echo html_escape($this->url(array(), null, $getParams)); ?>"><?php echo __('&#10094;'); ?></a>
    </li>
    <?php endif; ?>
    ...
    <li class="pagination_next">
      ...
      <a rel="next" href="<?php echo html_escape($this->url(array(), null, $getParams)); ?>"><?php echo __('&#10095;'); ?></a>
    </li>
    <?php endif; ?>
  </ul>
</nav>
