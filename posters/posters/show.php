...
$pageTitle = 'Album: &quot;' . html_escape($poster->title) . '&quot;';
...
<div id="poster">
    ...
    <?php if ($this->currentUser): ?>
        <div class="edit-link">
            ...
            <button type="button" onclick="window.location.href='<?php echo html_escape(url(array('action' => 'edit','id' => $poster->id), get_option('poster_page_path'))); ?>';">Edit</button>
            <button type="button" onclick="window.location.href='<?php echo html_escape(url(array('action'=>'print','id' => $poster->id), get_option('poster_page_path'))); ?>';">Print</button>
            <button type="button" onclick="window.location.href='/albums/browse/index';">View Others</button>
        </div>
    <?php endif; ?>
</div>
